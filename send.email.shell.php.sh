...
<?php
  ...
  $author = shell_exec( "svnlook author -r $rev $repos" );
  $date = shell_exec( "svnlook date -r $rev $repos" ); 
  $log = shell_exec( "svnlook log -r $rev $repos" );  
  $files = shell_exec( "svnlook changed -r $rev $repos" ); 
